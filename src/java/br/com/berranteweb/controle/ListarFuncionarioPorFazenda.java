 ...
 * @author jorge
 */
@WebServlet(name = "ListarFuncionarioPorFazenda", urlPatterns = {"/ListarFuncionarioPorFazenda"})
public class ListarFuncionarioPorFazenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            request.setAttribute("funcionarios", dao.listarPorFazenda(idFazenda));
