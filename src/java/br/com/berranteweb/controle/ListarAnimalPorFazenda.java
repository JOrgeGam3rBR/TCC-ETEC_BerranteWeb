 ...
 * @author jorge
 */
@WebServlet(name = "ListarAnimalPorFazenda", urlPatterns = {"/ListarAnimalPorFazenda"})
public class ListarAnimalPorFazenda extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
            ...
            request.setAttribute("animais", dao.listarPorFazenda(idFazenda));
